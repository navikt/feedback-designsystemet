...
const Post = ({ post }) => {
  ...
  return (
    <div className="flex flex-col flex-1 md:max-w-[70vw] min-w-[69vw] min-h-[70vh] mt-20 mb-20 border-2 rounded-md flex-initial mx-auto bg-white max-w-[2200px] p-20">
